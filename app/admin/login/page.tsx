...
export default function AdminLoginPage() {
  const [email, setEmail] = useState("admin@studentbuzz.pk")
      ...
      <div className="w-full max-w-md">
        <div className="card">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gradient">Admin Portal</h1>
            <p className="text-muted mt-2">Manage vendors and discounts</p>
          </div>
